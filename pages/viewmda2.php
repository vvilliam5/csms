...
<html lang="en">
    ...
    <body>
        <?php
            ...
            $word_mda2 = $_SERVER['QUERY_STRING'];
            $word_mda2 = substr($word_mda2, 13);
        ?>
        <div class="container-fluid">
            ...
            <div class="container-fluid" style="font-size:xx-small">
                <table class="table table-hover table-responsive-sm table-bordered">
                    ...
                    <?php
                        $query = "SELECT * FROM $word_mda2 WHERE principal = '0' ORDER BY number";
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a class="editLinkC" href="editperson.php?<?php echo $rows['number'];?>">Edit</a></td>
                        </tr>
                    </tbody>
                    <?php 
                        }
        ...
        <script>
            ...
            headref.textContent = mda.slice(0, 13);
            headref.textContent += " Officers";
            mdaref.textContent = mda.slice(0, 13);
            mdaprev.textContent = mda.substring(13);
            for(let i = 0; i < editLink.length; i += 1){
                editLink[i].href += mda.substring(13);
            }
        </script>
    </body>
</html>
